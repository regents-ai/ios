...
- This repo does not own live Regent agent, Regent Manager, or Talk business logic. The next slice should connect the current mobile routes to the owning product records
