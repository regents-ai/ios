...
export const TEST_ACCOUNTS = {
  ...
  emails: [
    'reviewer@regents-mobile.app',
    'devtest@regents-mobile.app'
  ],
  email: 'reviewer@regents-mobile.app',
  otp: '123456',
  ...
  seedPhrase: 'test flight review demo wallet please approve thank you regents reviewer mock seed phrase'
};
